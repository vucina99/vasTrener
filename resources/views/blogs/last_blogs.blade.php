...
<div class="container " id="blog">
    <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <small class="text-muted cat">
                        <i class="far fa-clock text-primary-secound"></i> 30 minutes
        ...
        <div class="col-12 text-center"><br><br>
            <button class="text-center btn btn-primary  all-blogs">Pogledaj sve blog postove &nbsp; <i class="fa-solid fa-spinner"></i></button>
        </div>
    </div>
    <br><br>
</div>
